 ...
 */
final class Version20210613133444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contenu CLOB NOT NULL COLLATE BINARY, date_creation DATETIME NOT NULL, date_modification DATETIME NOT NULL, titre VARCHAR(150) NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, titre, contenu, date_creation, date_modification FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contenu CLOB NOT NULL, date_creation DATETIME NOT NULL, date_modification DATETIME NOT NULL, titre VARCHAR(100) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO article (id, titre, contenu, date_creation, date_modification) SELECT id, titre, contenu, date_creation, date_modification FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_23A0E66FF7747B4 ON article (titre)');
        $this->addSql('DROP INDEX IDX_62A97E97294869C');
